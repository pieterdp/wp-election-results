...
function custom_js() {
    ...
    wp_register_script('datatables', 'https://cdn.datatables.net/v/dt/dt-1.10.18/datatables.min.js');
    ...
    wp_enqueue_script('datatables', 'https://cdn.datatables.net/v/dt/dt-1.10.18/datatables.min.js');
